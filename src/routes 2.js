...
const RequestVendorAssessment = React.lazy(() =>
  import("./views/VendorAssessment/RequestVendorAssessment")
);
const VendorAssessmentForm = React.lazy(() =>
  import("./views/VendorAssessment/VendorAssessmentForm")
);
...
const routes = [
  ...
  {
    path: "/vendorassessments/new",
    name: "Files to Upload",
    component: RequestVendorAssessment
  },
  {
